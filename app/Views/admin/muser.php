      ...
      <div class="container-fluid py-4 px-5">
        <div class="row">
          <div class="col-12">
            <div
              class="card card-background card-background-after-none align-items-start mt-4 mb-5"
            >
              <div
              ...
              <div class="card-body text-start p-4 w-100">
                ...
                <img
                  src="<?= base_url() ?>/Corporate/assets/img/3d-cube.png"
                  alt="3d-cube"
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="align-middle text-center">
                          <span
                            class="text-secondary text-sm font-weight-normal"
                            >23/04/18</span
                          >
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span
                            class="badge badge-sm border border-secondary text-secondary bg-secondary"
                            >Offline</span
                          >
                        </td>
                        <td class="align-middle text-center">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex align-items-center">
                              <img
                                src="<?= base_url() ?>/Corporate/assets/img/team-5.jpg"
                                class="avatar avatar-sm rounded-circle me-2"
                                alt="user5"
                              />
                            </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex align-items-center">
                              <img
                                src="<?= base_url() ?>/Corporate/assets/img/team-6.jpg"
                                class="avatar avatar-sm rounded-circle me-2"
                                alt="user6"
                              />
                            </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2">
                            ...
                            >
                              <img
                                src="<?= base_url() ?>/Corporate/assets/img/small-logos/logo-webdev.svg"
                                class="w-80"
                                alt="webdev"
                              />
                            </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2">
                            ...
                            >
                              <img
                                src="<?= base_url() ?>/Corporate/assets/img/small-logos/logo-xd.svg"
                                class="w-80"
                                alt="xd"
                              />
                            </div>
