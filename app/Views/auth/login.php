               ...
               <div class="row">
                     ...
                     <div class="card-body">
                       <form action="<?= url_to('login') ?>" method="post">
                         ...
                         <form role="form">
                           ...
                           <div class="mb-3">
                             <input type="text" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.emailOrUsername') ?>" aria-label="Name" aria-describedby="name-addon" />
                             <div class="invalid-feedback">
                               <?= session('errors.login') ?>
                             </div>
                           </div>
                           ...
                           <div class="d-flex align-items-center">
                             <div class="form-check form-check-info text-left mb-0">
                               <input class="form-check-input  <?php if (old('remember')) : ?> checked <?php endif ?>" type="checkbox" name="remember" id="flexCheckDefault" />
                               <label class="font-weight-normal text-dark mb-0" for="flexCheckDefault">
                                 <?= lang('Auth.rememberMe') ?>
                               </label>
                             </div>
                             <a href="<?= url_to('forgot') ?>" class="text-xs font-weight-bold ms-auto"><?= lang('Auth.forgotYourPassword') ?></a>
                           </div>
                 ...
                 <div class="col-md-6">
                   <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                     <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8" style="
