                                           ...
                                           <?php $nomor = 1 + (($nohalaman - 1)  * 5);
                                            foreach ($datapelanggan as $row) :  ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <td class="align-middle">
                                                       <a type="button" onclick="window.location='/produk/edit/<?= $row['pel_kode'] ?>'" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit user">
