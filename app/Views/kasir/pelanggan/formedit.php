       ...
       <div class="container-fluid py-4 px-5">
                       ...
                       <div class="card-header border-bottom pb-0">
                           ...
                           <div class="card-body">
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-sm-8">
                                       <input type="text" class="form-control" id="pel_nama" name="pel_nama" value="<?= $nama; ?>">
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-sm-4">
                                       <input type="text" class="form-control" id="pel_alamat" name="pel_alamat" value="<?= $alamat; ?>">
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-sm-4">
                                       <button type="submit" class="btn btn-dark btn-lg tombolSimpanPelanggan">Update</button>
                                   </div>
                               </div>
           ...
           <script>
               $('.tombolSimpanPelanggan').click(function(e) {
                   ...
                   $.ajax({
                       type: "post",
                       url: "<?= site_url('pelanggan/updatedata') ?>",
                       data: data,
                       dataType: "json",
